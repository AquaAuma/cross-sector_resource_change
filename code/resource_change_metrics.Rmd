...
s <- read_csv("/Users/auroremaureaud/Library/CloudStorage/Dropbox/Minerva 2021 Climate Politics/Aurore/Resource synthesis/future_resource_change/data/short-term_change/countries_shocks_1985-2015_probas.csv") %>% 
  filter(time_window == 30) %>% 
  pivot_longer(3:5, names_to = "type", values_to = "probas") %>% 
