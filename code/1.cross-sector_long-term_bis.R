...
#### Coding: Aurore Maureaud, November 2024
...
for(y in 1:length(yrs)){
  ...
  yy <- pct_diff_ts_g_cs %>% 
    ...
    summarize(at_least_half_change_5 = get_at_least_half(6, change_5),
              at_least_half_bis_change_5 = get_at_least_half_bis(6, change_5),
              at_least_half_change_10 = get_at_least_half(6, change_10),
              at_least_half_bis_change_10 = get_at_least_half_bis(6, change_10),
              at_least_half_change_25 = get_at_least_half(6, change_25),
              at_least_half_bis_change_25 = get_at_least_half_bis(6, change_25)) %>% 
    pivot_longer(3:8, names_to = "type", values_to = "probas") %>% 
...
# save outputs
write.csv(change_proba_g_cs, file = "data/long-term_change/global_long-term_change_1985-2015_probas_half.csv",
          row.names = F)
...
# save outputs
write.csv(change_proba_r_cs, file = "data/long-term_change/countries_long-term_change_1985-2015_probas_half.csv",
          row.names = F)
...
# save outputs
write.csv(change_proba_rta_cs, file = "data/long-term_change/rta_long-term_change_1985-2015_probas_half.csv",
          row.names = F)
