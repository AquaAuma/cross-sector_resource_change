...
A Savitsky-Golay low-pass filter (e.g., as in [this paper](<https://doi.org/10.1016/j.sigpro.2005.02.002>)) can detrend the data to isolate shocks.
...
<!-- -->
```
-   See brief description of Savitsky-Golay filters [here](<https://se.mathworks.com/help/signal/ref/sgolayfilt.html>).
...
The loess() function from the \`stats\` R package is used, where the parmeter controlling the degree of smoothing *span* is set at 2.
