...
plot_shocks_a <- dat_plot %>% 
  ...
  facet_grid(factor(n_res, levels=c("6","5","4","3","2"))~factor(scale, levels=c("abrupt","gradual"),
                    labels = c("Shocks","Gradual exposure")), 
...
plot_shocks_b <- dat_plot %>% 
  ...
  facet_grid(factor(n_res, levels=c("6","5","4","3","2"))
             ~factor(scale, levels=c("abrupt","gradual"),labels = c("Shocks","Gradual exposure")), 
...
png(paste0("figures/figure_4a.png"),
    width = 4*150, height = 16*200, res = 200)
plot_shocks_a
dev.off()

png(paste0("figures/figure_4b.png"),
    width = 4*150, height = 16*200, res = 200)
plot_shocks_b
dev.off()

png(paste0("figures/figure_4c.png"),
    width = 4*150, height = 16*200, res = 200)
plot_gradual_c
dev.off()

png(paste0("figures/figure_4d.png"),
    width = 4*150, height = 16*200, res = 200)
plot_gradual_d
dev.off()
